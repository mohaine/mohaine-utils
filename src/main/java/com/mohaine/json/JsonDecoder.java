...
public class JsonDecoder {
    ...
    public <T> T parseJson(Class<T> expectedType) {
        var obj = parseObject();

        return config.convertToObject(obj, expectedType);
    }
    ...
    private JsonUnknownObject parseObject() {
        int startIndex = offset;
        offset++;
